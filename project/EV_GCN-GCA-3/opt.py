...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--num_iter', default=500, type=int, help='number of epochs for training') #300
        parser.add_argument('--edropout', type=float, default=0.3, help='edge dropout rate') #0.3
        parser.add_argument('--dropout', default=0.2, type=float, help='ratio of dropout') #0.2
        ...
        #+
        parser.add_argument('--dataset', type=str, default='ODIR')
